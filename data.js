...
(function () {
  ...
  const KPIS = [
    ...
    },
    {
      ...
      short: "Points usage",
      nameAbout: "the points usage rate",
      category: "Transactional",
      type: "rate",
      defaultViz: "gauge",
      unit: "%",
    ...
    },
    {
      ...
      short: "Redemption",
      nameAbout: "the rewards redemption rate",
      category: "Transactional",
      type: "rate",
      defaultViz: "arc",
      unit: "%",
    ...
    },
    {
      ...
      short: "Referral CVR",
      nameAbout: "the referral conversion rate",
      category: "Referral",
      type: "rate",
      defaultViz: "gauge",
      unit: "%",
    ...
    },
    {
      ...
      nameAbout: "the new customer rate",
      category: "Referral",
      type: "rate",
      defaultViz: "arc",
      unit: "%",
    ...
    },
    {
      ...
      short: "Participation",
      nameAbout: "the participation rate",
      category: "Relational",
      type: "rate",
      defaultViz: "ring",
      unit: "%",
    ...
    },
    {
      ...
      short: "Orders growth",
      nameAbout: "number of orders growth",
      category: "Business",
      type: "growth",
      defaultViz: "bar",
      unit: "%",
