...
window.LOYOLY_I18N = {
  ...
  fr: {
    ui: {
      ...
      meth_lt_body:       "La LTV, l'AOV, le nombre moyen de commandes et le taux d'engagement ont été mesurés sur <strong>90 jours</strong> pour assurer une lecture stable des comportements et de la rentabilité du programme.",
  ...
  es: {
    ui: {
      ...
      meth_lt_body:       "LTV, AOV, promedio de pedidos y tasa de engagement se midieron en un período de <strong>90 días</strong> para garantizar una lectura estable del comportamiento de los miembros y la rentabilidad del programa.",
    ...
    sectors: {
      fashion: { name: "Moda & Ropa", short: "Moda", intro: "Las marcas de Moda & Ropa usan la fidelización para mantener la intención de compra entre ciclos estacionales y drops. Los miembros responden más a los accesos anticipados y experiencias VIP que a los descuentos, lo que genera una participación alta pero un valor de canje moderado. El reto principal es mantener el engagement en temporada baja mediante actividad de programa continua y experiencias exclusivas de pre-lanzamiento." },
      beauty:  { name: "Belleza & Wellness", short: "Belleza", intro: "Belleza & Wellness destaca por su alta frecuencia de compra natural y la conexión emocional que las marcas construyen con sus clientes. Los programas de fidelización se activan rápido y generan un fuerte engagement transaccional. La palanca real está en sostener ese impulso: convertir miembros activos en compradores habituales mediante actividad continua de programa y experiencias post-compra personalizadas." },
      food:    { name: "Alimentos & Bebidas", short: "Alimentos", intro: "Alimentos & Bebidas se beneficia de la mayor frecuencia de compra natural de todos los sectores, lo que impulsa una activación rápida y un uso intenso de puntos. Los carritos pequeños limitan el uplift de AOV, pero el volumen de transacciones hace que los programas de fidelización sean muy eficientes para crear hábitos de compra duraderos. La oportunidad está en usar esa frecuencia como palanca para profundizar el engagement mediante misiones y contenido." },
      health:  { name: "Salud & Suplementos", short: "Salud", intro: "Salud & Suplementos registra el mayor uplift de LTV de cualquier sector, impulsado por patrones de compra compatibles con la suscripción y un alto nivel de confianza entre marcas y clientes. Los miembros se reactivan rápidamente mediante misiones de win-back, y el referido juega un papel estructuralmente mayor que en otras categorías. La palanca a activar es convertir la satisfacción con el producto en boca a boca activo, apoyado en un programa de referidos sólido." },
      home:    { name: "Hogar & Decoración", short: "Hogar", intro: "Hogar & Decoración opera en ciclos de compra largos que reconfiguran fundamentalmente la dinámica de fidelización. El crecimiento de AOV en el canje es fuerte, pero la baja frecuencia de transacciones provoca desenganche entre compras, reduciendo las tasas de participación y canje. Las misiones de reengagement son el mecanismo principal para mantener vivo el programa entre momentos de compra." },
      petcare: { name: "Mascotas", short: "Mascotas", intro: "Mascotas destaca por la mayor conversión de referidos de cualquier sector, impulsada por el vínculo emocional entre dueños de mascotas que alimenta naturalmente el boca a boca. Los miembros están muy motivados y muestran una fuerte lealtad a la marca, pero el engagement del programa depende de cómo las marcas activen esa energía comunitaria mediante misiones y experiencias compartidas. Los dueños de mascotas hablan con otros dueños: el referido es la palanca de crecimiento a priorizar." },
      sports:  { name: "Deporte & Fitness", short: "Deporte", intro: "Deporte & Fitness genera la mayor participación en misiones de cualquier sector, reflejo de una audiencia orientada a la comunidad que responde naturalmente a los desafíos y objetivos colectivos. Los programas de fidelización funcionan mejor aquí cuando se construyen en torno a la identidad y el progreso compartido, más que a recompensas puramente transaccionales. La presión de márgenes limita el ROI frente a otros sectores, pero la profundidad del engagement crea una base sólida para la retención a largo plazo." }
    },
    categories: {
  ...
  en: {
    ui: {
      ...
      meth_lt_body:       "LTV, AOV, average orders, and engagement rate were measured over a <strong>90-day period</strong> to ensure a stable reading of member behaviour and program profitability.",
